...
export function KYCStatus({ status, onStartVerification, onContinueToOTP, onDownloadCertificate }) {
    ...
    return (<div className="max-w-4xl mx-auto">
      ...
      {/* Status Card */}
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white dark:bg-slate-800 border-2 border-gray-200 dark:border-slate-700 rounded-2xl p-8 mb-8">
      ...
      <div className="mb-8">
        ...
        <div className="space-y-4">
          {steps.map((step, index) => (<motion.div key={step.id} initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: index * 0.1 }} className={`flex items-center p-4 rounded-xl border-2 transition-all ${step.completed
              ...
              <div className="flex-1">
                ...
                {step.completed && (<p className="text-sm text-green-600 dark:text-green-400">
                    Completed
                  </p>)}
              </div>
            </motion.div>))}
      ...
      {/* Additional Info */}
      {status === "completed" && (<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6">
      ...
      {status === "rejected" && (<motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-6">
