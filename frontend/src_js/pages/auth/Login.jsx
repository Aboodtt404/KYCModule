      ...
      <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4">
        <div className="w-full max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* User Login Card */}
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 border border-gray-200 dark:border-slate-700 hover:shadow-xl hover:border-indigo-300 dark:hover:border-slate-600 transition-all duration-300 cursor-pointer group" onClick={handleUserLogin}>
            ...
            {/* Admin Login Card */}
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 border border-gray-200 dark:border-slate-700 hover:shadow-xl hover:border-purple-300 dark:hover:border-slate-600 transition-all duration-300 cursor-pointer group" onClick={handleAdminLogin}>
              <div className="text-center">
          ...
          <div className="flex justify-center mt-8">
            <button onClick={() => setDarkMode(!darkMode)} className={`w-16 h-8 rounded-full flex items-center px-1 transition-colors duration-200 ${darkMode ? "bg-indigo-900" : "bg-gray-300"}`}>
