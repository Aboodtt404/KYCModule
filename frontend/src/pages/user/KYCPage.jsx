        ...
        switch (step) {
            ...
            case 5:
                if (userData.needsEditing) {
                    return (<FieldEditStep ocrData={userData.ocrData || {}} faceImage={userData.faceImage || ""} onNext={handleFieldEditSubmit} onBack={handleBack}/>);
                }
                else {
                    return (<ReviewStep userData={userData} editedData={userData.editedData} onNext={handleNext}/>);
                }
            case 6:
                return <SuccessStep />;
            default:
