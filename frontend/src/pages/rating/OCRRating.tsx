  ...
  const StarRating = ({
    ...
    <div className="flex space-x-1">
      {[1, 2, 3, 4, 5].map((star) => (
        ...
        >
          <Star
            className={`w-7 h-7 ${star <= (hoveredRating || rating)
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {imageFiles.map((file, index) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-3 py-2 rounded-lg border text-sm transition-colors ${selectedImage?.path === file.path
        ...
        <div className="lg:col-span-2 bg-white dark:bg-glass dark:border-white/10 border border-gray-200 rounded-2xl shadow-sm p-6">
          ...
          {!selectedImage ? (
            <div className="text-center py-12 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl text-gray-600 dark:text-gray-400">
                ...
                <div className="text-center">
                  ...
                  <div className="flex justify-center mb-4">
                    <StarRating
                      ...
                      onRate={(rating) => {
                        const docIndex = imageFiles.findIndex(
                          (f) => f.path === selectedImage.path
                        );
                        if (docIndex !== -1) {
