...
export default function ReviewStep({
  ...
  // Use editedData if available, otherwise use the original OCR data
  const displayData = editedData || userData?.ocrData || {};

  console.log("ReviewStep - userData:", userData);
  console.log("ReviewStep - editedData:", editedData);
  console.log("ReviewStep - displayData:", displayData);
  console.log("ReviewStep - userData.ocrData:", userData?.ocrData);
  console.log("ReviewStep - userData keys:", Object.keys(userData || {}));
        ...
        {displayData && Object.keys(displayData).length > 0 && (
          <div className="mt-4 pt-4 border-t border-gray-600">
            ...
            {Object.entries(displayData)
              .filter(([key]) => key !== 'face_image') // Don't display face image in the list
              .map(([key, value]) => (
