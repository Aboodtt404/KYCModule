  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="bg-white dark:bg-glass dark:backdrop-blur-md border border-gray-200 dark:border-white/10 rounded-2xl shadow-sm p-6 transition-all">
        {uploadStatus === "idle" && (
          <div
            className={`relative border-2 border-dashed rounded-xl p-10 text-center cursor-pointer transition-colors ${dragActive
        ...
        {uploadStatus === "success" && (
          <div className="text-center py-8">
            ...
            <button
              onClick={resetUpload}
              className="px-6 py-2 rounded-lg font-medium bg-blue-600 text-white hover:bg-blue-700 dark:hover:bg-blue-500 transition-colors"
            >
              Upload Another File
            </button>
          </div>
