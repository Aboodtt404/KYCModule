      ...
      <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex text-gray-900 dark:text-white">
        ...
        >
          <div className="p-6 border-b border-gray-200 dark:border-slate-700 flex items-center justify-between">
            <h1
              className={`font-bold text-lg text-gray-900 dark:text-white transition-all ${
                  ...
                  <Tooltip key={tab.id}>
                    <TooltipTrigger asChild>
                      <NavLink
                        to={tab.to}
                        className={({ isActive }) =>
                          `w-full flex items-center px-6 py-3 mb-1 rounded-r-full transition-colors border-l-4 ${
                            isActive
