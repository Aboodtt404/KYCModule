    ...
    <GlassCard>
      ...
      >
            ...
            return (
              <div className="grid w-full items-center gap-1.5" key={key}>
                ...
                <Input
                  ...
                  value={value}
                  disabled
                  className="bg-white/10 dark:bg-gray-800 border border-gray-300/30 dark:border-gray-700/50 text-gray-900 dark:text-gray-100"
                />
              </div>
            );
          })}
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-6 w-full max-w-md">
          <Button
            onClick={onNext}
            className="flex-1 h-12 text-lg font-semibold bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white shadow-md hover:shadow-lg transition-all"
          >
          ...
          <Button
            onClick={onEdit}
            variant="outline"
            className="flex-1 h-12 text-lg font-semibold border-2 border-blue-500 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-all"
          >
            <div className="flex items-center gap-2 justify-center">
