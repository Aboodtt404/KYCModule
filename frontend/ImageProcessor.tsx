...
type EnhancementType = 'greyscale' | 'brightness' | 'contrast' | 'sharpness';
...
export function ImageProcessor() {
  ...
  const loadImage = useCallback(async (file: FileMetadata) => {
    try {
  ...
  const handleEnhancementChange = (type: EnhancementType, value: number) => {
  ...
  const saveProcessed = useCallback(async () => {
    if (!processedUrl || !selectedImage || !canvasRef.current) return;
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              ...
              <div className="space-y-2">
                ...
                <button
                  ...
                  className="w-full bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 disabled:opacity-50 transition-colors flex items-center justify-center"
                >
